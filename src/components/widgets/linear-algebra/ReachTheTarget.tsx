...
const DESCRIPTOR: WidgetDescriptor = {
  name: "Reach the target — multi-coefficient span puzzle",
  description:
  ...
  teaches: ["span", "linear combination", "lattice"],
  howToRead:
    "Drag u and v on the canvas to choose a basis, then slide α and β to build α·u + β·v and land the green dot on the red target T. Integer mode snaps the coefficients so only lattice nodes are reachable; continuous mode reaches every point of span(u, v).",
  controls: [
    { kind: "drag", label: "basis vector u" },
    { kind: "drag", label: "basis vector v" },
    { kind: "slider", label: "α", min: -4, max: 4, step: 0.05 },
    { kind: "slider", label: "β", min: -4, max: 4, step: 0.05 },
    { kind: "toggle", label: "integer / continuous mode" },
    { kind: "button", label: "auto-solve / reset / puzzle pick" },
  ],
  invariants: [
    "the green output dot equals α·u + β·v",
    "in integer mode α and β are whole numbers",
